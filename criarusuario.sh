										...
										then
											...
											then
												...
												then
													...
													[ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo "Usuário $username criado" ; echo "Data de expiração: $gui" ; echo "Nº de conexões simultâneas permitidas: $sshlimiter" ; echo "Senha:$password" ; echo "IP do Servidor: $ip" || echo "Não foi possível criar o usuário!" ; tput sgr0
